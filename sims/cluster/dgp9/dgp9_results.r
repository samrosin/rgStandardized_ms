...
# the user_home_dir *must* initially contain two empty sub-directories titled dgp9_datasets/ and dgp9_results/
...
load((paste("dgp9_datasets/sim_", sim, ".RData", sep=""))) # load .RData file
...
output_filename <- paste("dgp9_results/results_", sim, ".csv", sep="")
