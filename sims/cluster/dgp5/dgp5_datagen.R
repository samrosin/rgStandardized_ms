...
# the user_home_dir *must* initially contain two empty sub-directories titled dgp5_datasets/ and dgp5_results/
...
# recall dgp5 uses dgp3 stratum_props
...
output_filename <- paste("dgp5_datasets/sim_",sim,".RData",sep="")
