...
# the user_home_dir *must* initially contain two empty sub-directories titled dgp10_datasets/ and dgp10_results/
...
load((paste("dgp10_datasets/sim_", sim, ".RData", sep=""))) # load .RData file
...
output_filename <- paste("dgp10_results/results_", sim, ".csv", sep="")
