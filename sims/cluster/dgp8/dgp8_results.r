...
# the user_home_dir *must* initially contain two empty sub-directories titled dgp8_datasets/ and dgp8_results/
...
load((paste("dgp8_datasets/sim_", sim, ".RData", sep=""))) # load .RData file
...
output_filename <- paste("dgp8_results/results_", sim, ".csv", sep="")
